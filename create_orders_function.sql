-- Vytvoření funkce pro vytvoření tabulky orders, pokud neexistuje
...
AS $$
BEGIN
  -- Kontrola, zda tabulka orders existuje
  IF NOT EXISTS (
...
-- Vytvoření funkce pro spuštění SQL dotazu
